                ...
                <View style={checkOutStyles.voucherPrimaryContainer}>
                    {
                        selectedVoucherLength > 0 ?
                            ...
                            :
                            <Text style={{  fontSize: 14,color: '#fff', width: '70%',  alignSelf: 'center',textAlign: 'center',  }} numberOfLines={1}>{`You have ${state.promoList.length > 2 ? state.promoList.length : 0} vouchers`}</Text>
