        ...
        if (statusCode === 200) {
          NavigationService.NavigationActions.common_actions.navigate(ROUTES.APP_DRAWER_ROUTES.WebView.screen_name, {
            uri: {
              ...
              method: 'POST',
              body: `pp_Amount=${jazzCashAuthViewModel.pp_Amount}&pp_BankID=${jazzCashAuthViewModel.pp_BankID}&pp_BillReference=${jazzCashAuthViewModel.pp_BillReference}&pp_CNIC=${jazzCashAuthViewModel.pp_CNIC}&pp_Description=${jazzCashAuthViewModel.pp_Description}&pp_Language=${jazzCashAuthViewModel.pp_Language}&pp_MerchantID=${jazzCashAuthViewModel.pp_MerchantID}&pp_MobileNumber=${jazzCashAuthViewModel.pp_MobileNumber}&pp_Password=${jazzCashAuthViewModel.pp_Password}&pp_ProductID=${jazzCashAuthViewModel.pp_ProductID}&pp_SecureHash=${jazzCashAuthViewModel.pp_SecureHash}&pp_TxnCurrency=${jazzCashAuthViewModel.pp_TxnCurrency}&pp_TxnDateTime=${jazzCashAuthViewModel.pp_TxnDateTime}&pp_TxnExpiryDateTime=${jazzCashAuthViewModel.pp_TxnExpiryDateTime}&pp_TxnRefNo=${jazzCashAuthViewModel.pp_TxnRefNo}&ppmpf_1=${jazzCashAuthViewModel.ppmpf_1}&ppmpf_2=${jazzCashAuthViewModel.ppmpf_2}&ppmpf_3=${jazzCashAuthViewModel.ppmpf_3}&ppmpf_4=${jazzCashAuthViewModel.ppmpf_4}&ppmpf_5=${jazzCashAuthViewModel.ppmpf_5}`
            },
            html: null,
            title: "Top Up"
          })
