...
import { Alert, Animated, Appearance, Easing, Platform, ScrollView, StyleSheet, TouchableOpacity, } from "react-native";
        ...
        return (
            <AnimatedView style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, alignItems: 'center', marginHorizontal: 12, height: 80 }}>
                <View style={{
                    ...
                    <TouchableScale onPress={() => { itemCountOnPress("minus") }}  >
                        <VectorIcon
                            name="minus"
                    ...
                    <TouchableScale onPress={() => { itemCountOnPress("plus") }} >
                        <VectorIcon
                            name="plus"
                            type="MaterialCommunityIcons"
                            size={25}
