...
const Dropdown = ({ collapsed,options=[],itemUI= null,scrollViewStyles={} }) => {
    ...
    return (
        <ScrollView style={{ position:'absolute',display:!collapsed || shown === true?'flex':'none',maxHeight:250, overflow: 'hidden',width:'100%',borderBottomRightRadius:12,borderBottomLeftRadius:12,zIndex:99999999,...scrollViewStyles }}>
            <Animated.View style={{
