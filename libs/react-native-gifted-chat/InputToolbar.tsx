...
import AppStyles from '../../src/res/AppStyles'
...
> {
  ...
  renderSend() {
    if (this.props.renderSend) {
      return this.props.renderSend({ ...this.props, renderComposer: this.props.renderComposer })
    }
    return <Send {...this.props} renderComposer={this.props.renderComposer} />
  }
